///////////////////////////////////////////////////////////////////
// Modified node-google-distance by Edward Look
// Original source code: https://github.com/edwlook/node-google-distance
///////////////////////////////////////////////////////////////////
...
var formatResults = function(data, options, callback) {
  var formatData = function (element) {
    return {
      ...
      duration_in_traffic: element.duration_in_traffic.text,    // added
...
var fetchData = function(options, callback) {
    console.log(DISTANCE_API_URL + qs.stringify(options));   // added
